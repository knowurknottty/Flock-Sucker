package com.inversionlabs.flocksucker.auto
 ...
 *
 * @see FlockSuckerSession
 * @see AutoMainScreen
 */
class FlockSuckerCarAppService : CarAppService() {
    ...
    override fun onCreate() {
        super.onCreate()
        Log.i(TAG, "FlockSuckerCarAppService created")
    }

    override fun onDestroy() {
        Log.i(TAG, "FlockSuckerCarAppService destroyed")
        super.onDestroy()
    }
    ...
    companion object {
        private const val TAG = "FlockSuckerCarAppService"
