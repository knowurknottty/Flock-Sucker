package com.inversionlabs.flocksucker.worker
...
import com.inversionlabs.flocksucker.ai.DetectionAnalyzer
import com.inversionlabs.flocksucker.ai.FalsePositiveAnalyzer
import com.inversionlabs.flocksucker.ai.FalsePositiveResult
import com.inversionlabs.flocksucker.ai.FpAnalysisMethod
import com.inversionlabs.flocksucker.ai.LlmEngine
import com.inversionlabs.flocksucker.ai.LlmEngineManager
import com.inversionlabs.flocksucker.data.AiSettingsRepository
...
class BackgroundAnalysisWorker @AssistedInject constructor(
        ...
        val filteredDetections = when (priorityMode) {
            PRIORITY_HIGH -> {
                ...
                allDetections.filter {
                    it.threatLevel == com.inversionlabs.flocksucker.data.model.ThreatLevel.HIGH ||
                    it.threatLevel == com.inversionlabs.flocksucker.data.model.ThreatLevel.CRITICAL
                }
            }
            PRIORITY_LOW -> {
                // Only low-threat detections for idle-time analysis
                allDetections.filter {
                    it.threatLevel == com.inversionlabs.flocksucker.data.model.ThreatLevel.LOW ||
                    it.threatLevel == com.inversionlabs.flocksucker.data.model.ThreatLevel.INFO
                }
            }
    ...
    fun shouldTriggerHighPriority(detection: Detection): Boolean {
        return detection.threatLevel == com.inversionlabs.flocksucker.data.model.ThreatLevel.HIGH ||
               detection.threatLevel == com.inversionlabs.flocksucker.data.model.ThreatLevel.CRITICAL
    }
