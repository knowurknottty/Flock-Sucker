...
import com.inversionlabs.flocksucker.data.FeasibilityData
import com.inversionlabs.flocksucker.data.model.Detection
import com.inversionlabs.flocksucker.data.model.ThreatLevel
import com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssAnomalyAnalysis
import com.inversionlabs.flocksucker.privilege.PrivilegeMode
import com.inversionlabs.flocksucker.service.CellularMonitor.CellularAnomalyAnalysis
import com.inversionlabs.flocksucker.service.RogueWifiMonitor.FollowingNetworkAnalysis
import com.inversionlabs.flocksucker.service.UltrasonicDetector.BeaconAnalysis
...
JSON:"""
    ...
    private fun estimateFalsePositiveLikelihood(
        ...
        return when (detection.deviceType) {
            com.inversionlabs.flocksucker.data.model.DeviceType.RING_DOORBELL,
            com.inversionlabs.flocksucker.data.model.DeviceType.NEST_CAMERA,
            com.inversionlabs.flocksucker.data.model.DeviceType.WYZE_CAMERA,
            com.inversionlabs.flocksucker.data.model.DeviceType.ARLO_CAMERA,
            com.inversionlabs.flocksucker.data.model.DeviceType.EUFY_CAMERA,
            com.inversionlabs.flocksucker.data.model.DeviceType.BLINK_CAMERA -> 80
            com.inversionlabs.flocksucker.data.model.DeviceType.AIRTAG,
            com.inversionlabs.flocksucker.data.model.DeviceType.TILE_TRACKER,
            com.inversionlabs.flocksucker.data.model.DeviceType.SAMSUNG_SMARTTAG ->
                if (detection.rssi < -70) 60 else 20
            com.inversionlabs.flocksucker.data.model.DeviceType.BLUETOOTH_BEACON,
            com.inversionlabs.flocksucker.data.model.DeviceType.RETAIL_TRACKER -> 75
            com.inversionlabs.flocksucker.data.model.DeviceType.STINGRAY_IMSI,
            com.inversionlabs.flocksucker.data.model.DeviceType.GNSS_SPOOFER,
            com.inversionlabs.flocksucker.data.model.DeviceType.GNSS_JAMMER ->
