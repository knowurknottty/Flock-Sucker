...
class EnrichedDataCache @Inject constructor() {
     ...
     */
    fun putCellular(detectionId: String, analysis: com.inversionlabs.flocksucker.service.CellularMonitor.CellularAnomalyAnalysis) {
     ...
     */
    fun putGnss(detectionId: String, analysis: com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssAnomalyAnalysis) {
     ...
     */
    fun putUltrasonic(detectionId: String, analysis: com.inversionlabs.flocksucker.service.UltrasonicDetector.BeaconAnalysis) {
     ...
     */
    fun putWifiFollowing(detectionId: String, analysis: com.inversionlabs.flocksucker.service.RogueWifiMonitor.FollowingNetworkAnalysis) {
