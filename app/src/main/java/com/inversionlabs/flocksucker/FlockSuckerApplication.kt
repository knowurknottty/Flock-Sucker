...
import com.inversionlabs.flocksucker.util.NotificationChannelIds
import com.inversionlabs.flocksucker.worker.BackgroundAnalysisWorker
import com.inversionlabs.flocksucker.worker.DeadManSwitchWorker
...
@HiltAndroidApp
class FlockSuckerApplication : Application(), Configuration.Provider {

    companion object {
        private const val TAG = "FlockSuckerApplication"
    }
    ...
    private fun startScanningService() {
        try {
            val serviceIntent = Intent(this, ScanningService::class.java).apply {
                action = "com.inversionlabs.flocksucker.START_SCANNING"
            }
