package com.inversionlabs.flocksucker.data.export
 ...
 * @param startTime         inclusive lower bound on [com.inversionlabs.flocksucker.data.model.Detection.timestamp]
