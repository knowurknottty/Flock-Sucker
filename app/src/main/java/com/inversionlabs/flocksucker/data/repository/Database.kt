...
@Database(
    entities = [
        ...
        com.inversionlabs.flocksucker.data.model.Sighting::class,
        Observation::class,
        IdentityLink::class
    ],
    version = 13,
...
abstract class FlockSuckerDatabase : RoomDatabase() {
    ...
    companion object {
        private const val TAG = "FlockSuckerDatabase"

        @Volatile
        private var INSTANCE: FlockSuckerDatabase? = null
        ...
        fun getDatabase(context: Context): FlockSuckerDatabase {
