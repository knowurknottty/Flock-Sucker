...
class DetectionDeduplicator @Inject constructor() {
    ...
    private fun getThrottleWindow(detection: Detection): Long {
        return when (detection.protocol) {
            com.inversionlabs.flocksucker.data.model.DetectionProtocol.BLUETOOTH_LE -> BLE_THROTTLE_WINDOW_MS
            com.inversionlabs.flocksucker.data.model.DetectionProtocol.WIFI -> WIFI_THROTTLE_WINDOW_MS
