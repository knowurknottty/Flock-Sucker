...
import com.inversionlabs.flocksucker.evidence.IdentityDecision
import com.inversionlabs.flocksucker.evidence.IdentityDecisionClass
...
class DetectionRepository @Inject constructor(
    private val database: FlockSuckerDatabase,
    ...
    fun sightingsForDetection(detectionId: String): Flow<List<com.inversionlabs.flocksucker.data.model.Sighting>> =
        sightingDao.forDetection(detectionId)

    fun locatedSightingsForDetection(detectionId: String): Flow<List<com.inversionlabs.flocksucker.data.model.Sighting>> =
        sightingDao.locatedForDetection(detectionId)

    val totalSightingCount: Flow<Long> = sightingDao.countAll()

    suspend fun recentSightings(detectionId: String, limit: Int = 50): List<com.inversionlabs.flocksucker.data.model.Sighting> =
