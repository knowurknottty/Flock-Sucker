package com.inversionlabs.flocksucker.data.model
...
object DetectionPatterns {
    ...
    val macPrefixes = listOf(
        ...
        MacPrefix("24:5A:4C", DeviceType.WYZE_CAMERA, "Ubiquiti UniFi Protect", 65,
            "UniFi Protect camera"),
        MacPrefix("E0:A7:00", DeviceType.CCTV_CAMERA, "Verkada", 80,
            "Verkada cloud-managed enterprise camera; vendor-documented camera OUI"),
    ...
    fun cameraDefaultPortsForVendor(vendor: String): List<Int> =
        com.inversionlabs.flocksucker.data.model.CameraSignatures.vendors
