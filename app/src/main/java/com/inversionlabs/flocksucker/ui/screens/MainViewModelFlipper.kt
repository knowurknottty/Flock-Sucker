 ...
 */
fun MainViewModel.connectToDiscoveredFlipper(device: com.inversionlabs.flocksucker.scanner.flipper.DiscoveredFlipperDevice) {
 ...
 */
fun MainViewModel.connectToRecentFlipper(device: com.inversionlabs.flocksucker.scanner.flipper.RecentFlipperDevice) {
 ...
 */
fun MainViewModel.triggerFlipperManualScan(scanType: com.inversionlabs.flocksucker.scanner.flipper.FlipperScanType): Boolean {
