...
import com.inversionlabs.flocksucker.data.BroadcastSettings
import com.inversionlabs.flocksucker.data.BroadcastSettingsRepository
import com.inversionlabs.flocksucker.data.DetectionSettingsRepository
import com.inversionlabs.flocksucker.data.FlipperUiSettings
import com.inversionlabs.flocksucker.data.FlipperUiSettingsRepository
import com.inversionlabs.flocksucker.data.NetworkSettings
import com.inversionlabs.flocksucker.data.NetworkSettingsRepository
import com.inversionlabs.flocksucker.data.OuiSettings
...
import com.inversionlabs.flocksucker.data.repository.EphemeralDetectionRepository
...
import com.inversionlabs.flocksucker.network.TorConnectionStatus
import com.inversionlabs.flocksucker.scanner.flipper.FlipperClient
import com.inversionlabs.flocksucker.scanner.flipper.FlipperConnectionState
import com.inversionlabs.flocksucker.scanner.flipper.FlipperOnboardingRepository
import com.inversionlabs.flocksucker.scanner.flipper.FlipperOnboardingSettings
import com.inversionlabs.flocksucker.scanner.flipper.FlipperScannerManager
import com.inversionlabs.flocksucker.scanner.flipper.FlipperSettings
import com.inversionlabs.flocksucker.scanner.flipper.FlipperSettingsRepository
import com.inversionlabs.flocksucker.scanner.flipper.FlipperStatusResponse
import com.inversionlabs.flocksucker.service.CellularMonitor
...
data class MainUiState(
    ...
    // Status information
    val scanStatus: com.inversionlabs.flocksucker.service.ScanStatus = com.inversionlabs.flocksucker.service.ScanStatus.Idle,
    val bleStatus: com.inversionlabs.flocksucker.service.SubsystemStatus = com.inversionlabs.flocksucker.service.SubsystemStatus.Idle,
    val wifiStatus: com.inversionlabs.flocksucker.service.SubsystemStatus = com.inversionlabs.flocksucker.service.SubsystemStatus.Idle,
    val locationStatus: com.inversionlabs.flocksucker.service.SubsystemStatus = com.inversionlabs.flocksucker.service.SubsystemStatus.Idle,
    val cellularStatus: com.inversionlabs.flocksucker.service.SubsystemStatus = com.inversionlabs.flocksucker.service.SubsystemStatus.Idle,
    val satelliteStatus: com.inversionlabs.flocksucker.service.SubsystemStatus = com.inversionlabs.flocksucker.service.SubsystemStatus.Idle,
    val recentErrors: List<com.inversionlabs.flocksucker.service.ScanError> = emptyList(),
    // Seen devices (from IPC)
    val seenBleDevices: List<com.inversionlabs.flocksucker.service.SeenDevice> = emptyList(),
    val seenWifiNetworks: List<com.inversionlabs.flocksucker.service.SeenDevice> = emptyList(),
    // Cellular monitoring
    ...
    val satelliteState: com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionState? = null,
    val satelliteAnomalies: List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomaly> = emptyList(),
    val satelliteHistory: List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionEvent> = emptyList(),
    // Rogue WiFi monitoring
    val rogueWifiStatus: com.inversionlabs.flocksucker.service.RogueWifiMonitor.WifiEnvironmentStatus? = null,
    val rogueWifiAnomalies: List<com.inversionlabs.flocksucker.service.RogueWifiMonitor.WifiAnomaly> = emptyList(),
    val suspiciousNetworks: List<com.inversionlabs.flocksucker.service.RogueWifiMonitor.SuspiciousNetwork> = emptyList(),
    // RF signal analysis
    val rfStatus: com.inversionlabs.flocksucker.service.RfSignalAnalyzer.RfEnvironmentStatus? = null,
    val rfAnomalies: List<com.inversionlabs.flocksucker.service.RfSignalAnalyzer.RfAnomaly> = emptyList(),
    val detectedDrones: List<com.inversionlabs.flocksucker.service.RfSignalAnalyzer.DroneInfo> = emptyList(),
    // Ultrasonic detection
    val ultrasonicStatus: com.inversionlabs.flocksucker.service.UltrasonicDetector.UltrasonicStatus? = null,
    val ultrasonicAnomalies: List<com.inversionlabs.flocksucker.service.UltrasonicDetector.UltrasonicAnomaly> = emptyList(),
    val ultrasonicBeacons: List<com.inversionlabs.flocksucker.service.UltrasonicDetector.BeaconDetection> = emptyList(),
    // GNSS satellite monitoring
    val gnssStatus: com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEnvironmentStatus? = null,
    val gnssSatellites: List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.SatelliteInfo> = emptyList(),
    val gnssAnomalies: List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssAnomaly> = emptyList(),
    val gnssEvents: List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEvent> = emptyList(),
    val gnssMeasurements: com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssMeasurementData? = null,
    // Detector health status
    val detectorHealth: Map<String, com.inversionlabs.flocksucker.service.DetectorHealthStatus> = emptyMap(),
    // Scan statistics
    val scanStats: com.inversionlabs.flocksucker.service.ScanStatistics = com.inversionlabs.flocksucker.service.ScanStatistics(),
    // Threading monitor
    val threadingSystemState: com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.SystemThreadingState? = null,
    val threadingScannerStates: Map<String, com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.ScannerThreadState> = emptyMap(),
    val threadingAlerts: List<com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.ThreadingAlert> = emptyList(),
    // Cross-detection pattern alerts
    val correlatedThreats: List<com.inversionlabs.flocksucker.ai.correlation.CorrelatedThreat> = emptyList(),
    ...
    val analysisResult: com.inversionlabs.flocksucker.data.AiAnalysisResult? = null,
    ...
    val flipperScanSchedulerStatus: com.inversionlabs.flocksucker.scanner.flipper.ScanSchedulerStatus = com.inversionlabs.flocksucker.scanner.flipper.ScanSchedulerStatus(),
    // Flipper UX improvements
    val flipperAutoReconnectState: com.inversionlabs.flocksucker.scanner.flipper.AutoReconnectState = com.inversionlabs.flocksucker.scanner.flipper.AutoReconnectState(),
    val flipperDiscoveredDevices: List<com.inversionlabs.flocksucker.scanner.flipper.DiscoveredFlipperDevice> = emptyList(),
    val flipperRecentDevices: List<com.inversionlabs.flocksucker.scanner.flipper.RecentFlipperDevice> = emptyList(),
...
class MainViewModel @Inject constructor(
    ...
    internal val scanSettingsRepository: com.inversionlabs.flocksucker.data.ScanSettingsRepository,
    ...
    internal val detectionAnalyzerLazy: Lazy<com.inversionlabs.flocksucker.ai.DetectionAnalyzer>,
    internal val crossDomainAnalyzer: com.inversionlabs.flocksucker.ai.correlation.CrossDomainAnalyzer,
    ...
    internal val enrichedDataCache: com.inversionlabs.flocksucker.ai.EnrichedDataCache  // Enriched detector data cache
    ...
    internal val detectionAnalyzer: com.inversionlabs.flocksucker.ai.DetectionAnalyzer
        get() = detectionAnalyzerLazy.get()

    // Privilege mode for feasibility-aware UI
    val privilegeMode: com.inversionlabs.flocksucker.privilege.PrivilegeMode =
        com.inversionlabs.flocksucker.privilege.PrivilegeModeDetector.detect(application)
    ...
    val detectionSettings: StateFlow<com.inversionlabs.flocksucker.data.DetectionSettings> = settingsRepository.settings
        .stateIn(
            scope = viewModelScope,
            started = SharingStarted.WhileSubscribed(5000),
            initialValue = com.inversionlabs.flocksucker.data.DetectionSettings()
        )

    val scanSettings: StateFlow<com.inversionlabs.flocksucker.data.ScanSettings> = scanSettingsRepository.settings
        .stateIn(
            scope = viewModelScope,
            started = SharingStarted.WhileSubscribed(5000),
            initialValue = com.inversionlabs.flocksucker.data.ScanSettings()
        )
            ...
            combine(
                ...
                _uiState.update {
                    it.copy(
                        ...
                        scanStatus = com.inversionlabs.flocksucker.service.ScanStatus.fromIpcString(update.scanStatus),
                        bleStatus = com.inversionlabs.flocksucker.service.SubsystemStatus.fromIpcString(update.bleStatus),
                        wifiStatus = com.inversionlabs.flocksucker.service.SubsystemStatus.fromIpcString(update.wifiStatus),
                        locationStatus = com.inversionlabs.flocksucker.service.SubsystemStatus.fromIpcString(update.locationStatus),
                        cellularStatus = com.inversionlabs.flocksucker.service.SubsystemStatus.fromIpcString(update.cellularStatus),
                        satelliteStatus = com.inversionlabs.flocksucker.service.SubsystemStatus.fromIpcString(update.satelliteStatus),
    ...
    private data class GnssDataUpdate(
        val status: com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEnvironmentStatus?,
        val satellites: List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.SatelliteInfo>,
        val anomalies: List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssAnomaly>,
        val events: List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEvent>,
        val measurements: com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssMeasurementData?
    )
    ...
    fun getVisibleCorrelatedThreats(): List<com.inversionlabs.flocksucker.ai.correlation.CorrelatedThreat> {
     ...
     */
    fun getEnrichedData(detectionId: String): com.inversionlabs.flocksucker.ai.EnrichedDetectorData? {
    ...
    fun startScanning() {
        ...
        _uiState.update { it.copy(isScanning = true, scanStatus = com.inversionlabs.flocksucker.service.ScanStatus.Starting) }
    ...
    fun stopScanning() {
        // Optimistically update UI state immediately for responsive feedback
        _uiState.update { it.copy(isScanning = false, scanStatus = com.inversionlabs.flocksucker.service.ScanStatus.Idle) }
