...
import com.inversionlabs.flocksucker.data.GnssPattern
import com.inversionlabs.flocksucker.data.RetentionPeriod
import com.inversionlabs.flocksucker.data.RfPattern
import com.inversionlabs.flocksucker.data.UltrasonicPattern
import com.inversionlabs.flocksucker.worker.DataRetentionWorker
import com.inversionlabs.flocksucker.worker.OuiUpdateWorker
 ...
 */
fun MainViewModel.applyProtectionPreset(preset: com.inversionlabs.flocksucker.data.ProtectionPreset) {
    viewModelScope.launch {
...
fun MainViewModel.toggleCellularPattern(pattern: com.inversionlabs.flocksucker.data.CellularPattern, enabled: Boolean) {
    viewModelScope.launch { settingsRepository.toggleCellularPattern(pattern, enabled) }
}

fun MainViewModel.toggleSatellitePattern(pattern: com.inversionlabs.flocksucker.data.SatellitePattern, enabled: Boolean) {
    viewModelScope.launch { settingsRepository.toggleSatellitePattern(pattern, enabled) }
}

fun MainViewModel.toggleBlePattern(pattern: com.inversionlabs.flocksucker.data.BlePattern, enabled: Boolean) {
    viewModelScope.launch { settingsRepository.toggleBlePattern(pattern, enabled) }
}

fun MainViewModel.toggleWifiPattern(pattern: com.inversionlabs.flocksucker.data.WifiPattern, enabled: Boolean) {
