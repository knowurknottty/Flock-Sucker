package com.inversionlabs.flocksucker.detection.handler
...
abstract class BaseDetectionHandler<T : DetectionContext> : DetectionHandler<T> {
    ...
    protected fun calculateProperThreatScore(
        baseLikelihood: Int,
        deviceType: com.inversionlabs.flocksucker.data.model.DeviceType,
        rssi: Int,
        seenCount: Int = 1,
        ...
        // Determine severity
        val severity = com.inversionlabs.flocksucker.data.model.scoreToThreatLevel(rawScore)
     ...
     */
    private fun getImpactFactor(deviceType: com.inversionlabs.flocksucker.data.model.DeviceType): Double = when (deviceType) {
        // Maximum impact - intercepts all communications
        com.inversionlabs.flocksucker.data.model.DeviceType.STINGRAY_IMSI -> 2.0
        com.inversionlabs.flocksucker.data.model.DeviceType.CELLEBRITE_FORENSICS -> 2.0
        com.inversionlabs.flocksucker.data.model.DeviceType.GRAYKEY_DEVICE -> 2.0
        com.inversionlabs.flocksucker.data.model.DeviceType.MAN_IN_MIDDLE -> 2.0

        // High impact - can cause physical harm
        com.inversionlabs.flocksucker.data.model.DeviceType.GNSS_SPOOFER -> 1.8
        com.inversionlabs.flocksucker.data.model.DeviceType.GNSS_JAMMER -> 1.8
        com.inversionlabs.flocksucker.data.model.DeviceType.RF_JAMMER -> 1.8
        com.inversionlabs.flocksucker.data.model.DeviceType.WIFI_PINEAPPLE -> 1.8
        com.inversionlabs.flocksucker.data.model.DeviceType.ROGUE_AP -> 1.7

        // Tracking/stalking concern
        com.inversionlabs.flocksucker.data.model.DeviceType.AIRTAG -> 1.5
        com.inversionlabs.flocksucker.data.model.DeviceType.TILE_TRACKER -> 1.5
        com.inversionlabs.flocksucker.data.model.DeviceType.SAMSUNG_SMARTTAG -> 1.5
        com.inversionlabs.flocksucker.data.model.DeviceType.GENERIC_BLE_TRACKER -> 1.5
        com.inversionlabs.flocksucker.data.model.DeviceType.TRACKING_DEVICE -> 1.5
        com.inversionlabs.flocksucker.data.model.DeviceType.SURVEILLANCE_VAN -> 1.5
        com.inversionlabs.flocksucker.data.model.DeviceType.DRONE -> 1.4

        // Privacy violations
        com.inversionlabs.flocksucker.data.model.DeviceType.HIDDEN_CAMERA -> 1.3
        com.inversionlabs.flocksucker.data.model.DeviceType.HIDDEN_TRANSMITTER -> 1.3
        com.inversionlabs.flocksucker.data.model.DeviceType.PACKET_SNIFFER -> 1.3
        com.inversionlabs.flocksucker.data.model.DeviceType.FLOCK_SAFETY_CAMERA -> 1.2
        com.inversionlabs.flocksucker.data.model.DeviceType.LICENSE_PLATE_READER -> 1.2
        com.inversionlabs.flocksucker.data.model.DeviceType.FACIAL_RECOGNITION -> 1.2

        // Standard surveillance
        com.inversionlabs.flocksucker.data.model.DeviceType.BODY_CAMERA -> 1.0
        com.inversionlabs.flocksucker.data.model.DeviceType.POLICE_VEHICLE -> 1.0
        com.inversionlabs.flocksucker.data.model.DeviceType.CCTV_CAMERA -> 1.0
        com.inversionlabs.flocksucker.data.model.DeviceType.ULTRASONIC_BEACON -> 1.0

        // Consumer IoT - lower impact
        com.inversionlabs.flocksucker.data.model.DeviceType.RING_DOORBELL -> 0.8
        com.inversionlabs.flocksucker.data.model.DeviceType.NEST_CAMERA -> 0.8
        com.inversionlabs.flocksucker.data.model.DeviceType.WYZE_CAMERA -> 0.8
        com.inversionlabs.flocksucker.data.model.DeviceType.AMAZON_SIDEWALK -> 0.7
        com.inversionlabs.flocksucker.data.model.DeviceType.BLUETOOTH_BEACON -> 0.7

        // Traffic infrastructure - minimal impact
        com.inversionlabs.flocksucker.data.model.DeviceType.SPEED_CAMERA -> 0.6
        com.inversionlabs.flocksucker.data.model.DeviceType.RED_LIGHT_CAMERA -> 0.6
        com.inversionlabs.flocksucker.data.model.DeviceType.TOLL_READER -> 0.6
        com.inversionlabs.flocksucker.data.model.DeviceType.TRAFFIC_SENSOR -> 0.5

        // Environmental/signal issues
        com.inversionlabs.flocksucker.data.model.DeviceType.RF_INTERFERENCE -> 0.5
        com.inversionlabs.flocksucker.data.model.DeviceType.RF_ANOMALY -> 0.5
