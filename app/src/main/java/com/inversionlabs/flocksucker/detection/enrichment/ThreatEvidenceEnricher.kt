...
object ThreatEvidenceEnricher {
    ...
    val PROBE_ELIGIBLE: Set<com.inversionlabs.flocksucker.data.model.ThreatLevel> =
        setOf(
            com.inversionlabs.flocksucker.data.model.ThreatLevel.HIGH,
            com.inversionlabs.flocksucker.data.model.ThreatLevel.CRITICAL
        )

    fun isProbeEligible(threatLevel: com.inversionlabs.flocksucker.data.model.ThreatLevel): Boolean =
