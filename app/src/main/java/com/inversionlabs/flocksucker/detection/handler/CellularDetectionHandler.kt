...
import com.inversionlabs.flocksucker.data.CellularPattern
import com.inversionlabs.flocksucker.data.CellularThresholds
...
import com.inversionlabs.flocksucker.detection.config.DetectionConstants
import com.inversionlabs.flocksucker.data.model.DeviceType
import com.inversionlabs.flocksucker.data.model.ThreatLevel
import com.inversionlabs.flocksucker.data.model.rssiToSignalStrength
...
class CellularDetectionHandler @Inject constructor(
    ...
    suspend fun convertShannonAnomalyToDetection(
        anomaly: com.inversionlabs.flocksucker.shannon.ShannonAnomaly,
        latitude: Double?,
        longitude: Double?
    ): Detection? {
        val settings = detectionSettingsRepository.settings.first()
        ...
        val pattern = when (anomaly.type) {
            com.inversionlabs.flocksucker.shannon.ShannonAnomalyType.NULL_CIPHER -> CellularPattern.SDM_NULL_CIPHER
            com.inversionlabs.flocksucker.shannon.ShannonAnomalyType.IMSI_PAGING -> CellularPattern.SDM_IMSI_PAGING
            com.inversionlabs.flocksucker.shannon.ShannonAnomalyType.SILENT_SMS -> CellularPattern.SDM_SILENT_SMS
            com.inversionlabs.flocksucker.shannon.ShannonAnomalyType.FORCED_2G -> CellularPattern.SDM_FORCED_2G
            com.inversionlabs.flocksucker.shannon.ShannonAnomalyType.AUTH_ANOMALY -> CellularPattern.SDM_AUTH_ANOMALY
        }
        ...
        val method = when (anomaly.type) {
            com.inversionlabs.flocksucker.shannon.ShannonAnomalyType.NULL_CIPHER -> DetectionMethod.SDM_NULL_CIPHER_DETECTED
            com.inversionlabs.flocksucker.shannon.ShannonAnomalyType.IMSI_PAGING -> DetectionMethod.SDM_IMSI_PAGING_DETECTED
            com.inversionlabs.flocksucker.shannon.ShannonAnomalyType.SILENT_SMS -> DetectionMethod.SDM_SILENT_SMS_DETECTED
            com.inversionlabs.flocksucker.shannon.ShannonAnomalyType.FORCED_2G -> DetectionMethod.SDM_FORCED_2G_DETECTED
            com.inversionlabs.flocksucker.shannon.ShannonAnomalyType.AUTH_ANOMALY -> DetectionMethod.SDM_AUTHENTICATION_ANOMALY
        }

        // Calculate threat score: SDM detections have inherently high confidence
        val threatScore = when (anomaly.severity) {
            com.inversionlabs.flocksucker.shannon.ShannonSeverity.CRITICAL -> (95 * anomaly.confidence).toInt()
            com.inversionlabs.flocksucker.shannon.ShannonSeverity.HIGH -> (85 * anomaly.confidence).toInt()
            com.inversionlabs.flocksucker.shannon.ShannonSeverity.MEDIUM -> (65 * anomaly.confidence).toInt()
            com.inversionlabs.flocksucker.shannon.ShannonSeverity.LOW -> (45 * anomaly.confidence).toInt()
        }.coerceIn(0, 100)

        val threatLevel = com.inversionlabs.flocksucker.data.model.scoreToThreatLevel(threatScore)
        ...
        return Detection(
            ...
            detectionSource = com.inversionlabs.flocksucker.data.model.DetectionSource.SHANNON_SDM
        )
    }

    private fun buildShannonRawData(anomaly: com.inversionlabs.flocksucker.shannon.ShannonAnomaly): String {
        return buildString {
