...
class ScanningServiceConnection(private val context: Context) {
    ...
    private val _satelliteState = MutableStateFlow<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionState?>(null)
    val satelliteState: StateFlow<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionState?> = _satelliteState.asStateFlow()

    private val _satelliteAnomalies = MutableStateFlow<List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomaly>>(emptyList())
    val satelliteAnomalies: StateFlow<List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomaly>> = _satelliteAnomalies.asStateFlow()

    private val _satelliteHistory = MutableStateFlow<List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionEvent>>(emptyList())
    val satelliteHistory: StateFlow<List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionEvent>> = _satelliteHistory.asStateFlow()
    ...
    private val _lastDetection = MutableStateFlow<com.inversionlabs.flocksucker.data.model.Detection?>(null)
    val lastDetection: StateFlow<com.inversionlabs.flocksucker.data.model.Detection?> = _lastDetection.asStateFlow()

    // Active detections list (mirrored from service process for cross-process clients like Android Auto)
    private val _activeDetections = MutableStateFlow<List<com.inversionlabs.flocksucker.data.model.Detection>>(emptyList())
    val activeDetections: StateFlow<List<com.inversionlabs.flocksucker.data.model.Detection>> = _activeDetections.asStateFlow()

    // GNSS satellite monitoring data (mirrored from service process)
    private val _gnssStatus = MutableStateFlow<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEnvironmentStatus?>(null)
    val gnssStatus: StateFlow<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEnvironmentStatus?> = _gnssStatus.asStateFlow()

    private val _gnssSatellites = MutableStateFlow<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.SatelliteInfo>>(emptyList())
    val gnssSatellites: StateFlow<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.SatelliteInfo>> = _gnssSatellites.asStateFlow()

    private val _gnssAnomalies = MutableStateFlow<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssAnomaly>>(emptyList())
    val gnssAnomalies: StateFlow<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssAnomaly>> = _gnssAnomalies.asStateFlow()

    private val _gnssEvents = MutableStateFlow<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEvent>>(emptyList())
    val gnssEvents: StateFlow<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEvent>> = _gnssEvents.asStateFlow()

    private val _gnssMeasurements = MutableStateFlow<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssMeasurementData?>(null)
    val gnssMeasurements: StateFlow<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssMeasurementData?> = _gnssMeasurements.asStateFlow()
    ...
    private val _threadingSystemState = MutableStateFlow<com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.SystemThreadingState?>(null)
    val threadingSystemState: StateFlow<com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.SystemThreadingState?> = _threadingSystemState.asStateFlow()

    private val _threadingScannerStates = MutableStateFlow<Map<String, com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.ScannerThreadState>>(emptyMap())
    val threadingScannerStates: StateFlow<Map<String, com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.ScannerThreadState>> = _threadingScannerStates.asStateFlow()

    private val _threadingAlerts = MutableStateFlow<List<com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.ThreadingAlert>>(emptyList())
    val threadingAlerts: StateFlow<List<com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.ThreadingAlert>> = _threadingAlerts.asStateFlow()
    ...
    internal fun updateSatelliteData(
        ...
        try {
            stateJson?.let {
                val state = ScanningServiceIpc.gson.fromJson(it, com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionState::class.java)
                _satelliteState.update { state }
            }
            anomaliesJson?.let {
                val type = object : TypeToken<List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomaly>>() {}.type
                val anomalies: List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomaly> = ScanningServiceIpc.gson.fromJson(it, type)
                _satelliteAnomalies.update { anomalies }
            }
            historyJson?.let {
                val type = object : TypeToken<List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionEvent>>() {}.type
                val history: List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionEvent> = ScanningServiceIpc.gson.fromJson(it, type)
    ...
    internal fun updateLastDetection(json: String?) {
        ...
        try {
            val detection = ScanningServiceIpc.gson.fromJson(json, com.inversionlabs.flocksucker.data.model.Detection::class.java)
    ...
    internal fun updateActiveDetections(json: String?) {
        ...
        try {
            val type = object : TypeToken<List<com.inversionlabs.flocksucker.data.model.Detection>>() {}.type
            val detections: List<com.inversionlabs.flocksucker.data.model.Detection> = ScanningServiceIpc.gson.fromJson(json, type)
    ...
    internal fun updateGnssData(
        ...
        try {
            statusJson?.let {
                val status = ScanningServiceIpc.gson.fromJson(it, com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEnvironmentStatus::class.java)
                _gnssStatus.update { status }
            }
            satellitesJson?.let {
                val type = object : TypeToken<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.SatelliteInfo>>() {}.type
                val satellites: List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.SatelliteInfo> = ScanningServiceIpc.gson.fromJson(it, type)
                _gnssSatellites.update { satellites }
            }
            anomaliesJson?.let {
                val type = object : TypeToken<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssAnomaly>>() {}.type
                val anomalies: List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssAnomaly> = ScanningServiceIpc.gson.fromJson(it, type)
                _gnssAnomalies.update { anomalies }
            }
            eventsJson?.let {
                val type = object : TypeToken<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEvent>>() {}.type
                val events: List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEvent> = ScanningServiceIpc.gson.fromJson(it, type)
                _gnssEvents.update { events }
            }
            measurementsJson?.let {
                val measurements = ScanningServiceIpc.gson.fromJson(it, com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssMeasurementData::class.java)
        ...
        try {
            systemStateJson?.let {
                val state = ScanningServiceIpc.gson.fromJson(
                    it,
                    com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.SystemThreadingState::class.java
                )
                _threadingSystemState.update { state }
            }
            scannerStatesJson?.let {
                val type = object : TypeToken<Map<String, com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.ScannerThreadState>>() {}.type
                val states: Map<String, com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.ScannerThreadState> = ScanningServiceIpc.gson.fromJson(it, type)
                _threadingScannerStates.update { states }
            }
            alertsJson?.let {
                val type = object : TypeToken<List<com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.ThreadingAlert>>() {}.type
                val alerts: List<com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor.ThreadingAlert> = ScanningServiceIpc.gson.fromJson(it, type)
