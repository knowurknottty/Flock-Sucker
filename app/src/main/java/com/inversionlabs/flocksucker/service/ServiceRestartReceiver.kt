...
class ServiceRestartReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        private const val ACTION_RESTART = "com.inversionlabs.flocksucker.RESTART_SERVICE"
        private const val ACTION_HEARTBEAT = "com.inversionlabs.flocksucker.SERVICE_HEARTBEAT"
    ...
    private fun startScanningService(context: Context) {
        ...
        try {
            val serviceIntent = Intent(context, ScanningService::class.java).apply {
                action = "com.inversionlabs.flocksucker.RESTART_SCANNING"
            }
