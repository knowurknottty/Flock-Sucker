...
import com.inversionlabs.flocksucker.detection.handler.SatelliteDetectionContext
    ...
    satelliteAnomalyJob = serviceScope.launch {
        satelliteMonitor?.anomalies?.collect { anomaly ->
            ...
            val connectionState = satelliteMonitor?.satelliteState?.value
                ?: com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionState()
...
internal fun ScanningService.satelliteAnomalyToDetection(anomaly: com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomaly): Detection? {
    val threatLevel = when (anomaly.severity) {
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.AnomalySeverity.CRITICAL -> ThreatLevel.CRITICAL
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.AnomalySeverity.HIGH -> ThreatLevel.HIGH
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.AnomalySeverity.MEDIUM -> ThreatLevel.MEDIUM
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.AnomalySeverity.LOW -> ThreatLevel.LOW
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.AnomalySeverity.INFO -> ThreatLevel.LOW
    }

    val detectionMethod = when (anomaly.type) {
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomalyType.UNEXPECTED_SATELLITE_CONNECTION,
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomalyType.SATELLITE_IN_COVERED_AREA -> DetectionMethod.SAT_UNEXPECTED_CONNECTION
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomalyType.FORCED_SATELLITE_HANDOFF -> DetectionMethod.SAT_FORCED_HANDOFF
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomalyType.DOWNGRADE_TO_SATELLITE -> DetectionMethod.SAT_DOWNGRADE
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomalyType.SUSPICIOUS_NTN_PARAMETERS,
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomalyType.NTN_BAND_MISMATCH -> DetectionMethod.SAT_SUSPICIOUS_NTN
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomalyType.TIMING_ADVANCE_ANOMALY,
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomalyType.EPHEMERIS_MISMATCH -> DetectionMethod.SAT_TIMING_ANOMALY
    ...
    return Detection(
        ...
        threatScore = when (anomaly.severity) {
            com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.AnomalySeverity.CRITICAL -> 100
            com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.AnomalySeverity.HIGH -> 80
            com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.AnomalySeverity.MEDIUM -> 50
            com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.AnomalySeverity.LOW -> 30
            com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.AnomalySeverity.INFO -> 10
        },
...
internal fun ScanningService.startGnssMonitoring() {
    ...
    if (gnssSatelliteMonitor == null) {
        gnssSatelliteMonitor = com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor(applicationContext, detectorCallbackImpl)
    }
...
internal fun ScanningService.sendSatelliteConnectionNotification(state: com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionState) {
    val providerName = when (state.provider) {
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteProvider.STARLINK -> "Starlink"
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteProvider.SKYLO -> "Skylo"
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteProvider.GLOBALSTAR -> "Globalstar"
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteProvider.AST_SPACEMOBILE -> "AST SpaceMobile"
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteProvider.LYNK -> "Lynk"
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteProvider.IRIDIUM -> "Iridium"
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteProvider.INMARSAT -> "Inmarsat"
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteProvider.UNKNOWN -> state.networkName ?: "Unknown"
    }
    val connectionTypeName = when (state.connectionType) {
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionType.T_MOBILE_STARLINK -> "T-Mobile Satellite"
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionType.SKYLO_NTN -> "Skylo NTN"
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionType.GENERIC_NTN -> "NTN"
        com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionType.PROPRIETARY -> "Proprietary Satellite"
        else -> "Satellite"
    }
...
internal fun ScanningService.startShannonDiagMonitoring() {
    ...
    val capability = com.inversionlabs.flocksucker.shannon.ShannonCapabilityDetector.detect()
    if (capability != com.inversionlabs.flocksucker.shannon.ShannonCapabilityDetector.ShannonStatus.AVAILABLE) {
    ...
    if (shannonDiagMonitor == null) {
        shannonDiagMonitor = com.inversionlabs.flocksucker.shannon.ShannonDiagMonitor(applicationContext) { name, error ->
    ...
    shannonStatusJob = serviceScope.launch {
        shannonDiagMonitor?.status?.collect { status ->
            ScanningServiceState.shannonDiagStatus.value = when (status) {
                com.inversionlabs.flocksucker.shannon.ShannonDiagStatus.ACTIVE -> SubsystemStatus.Active
                com.inversionlabs.flocksucker.shannon.ShannonDiagStatus.STARTING -> SubsystemStatus.Active
                com.inversionlabs.flocksucker.shannon.ShannonDiagStatus.RECONNECTING -> SubsystemStatus.Active
                com.inversionlabs.flocksucker.shannon.ShannonDiagStatus.IDLE -> SubsystemStatus.Idle
                com.inversionlabs.flocksucker.shannon.ShannonDiagStatus.UNAVAILABLE -> SubsystemStatus.Error(-1, "Unavailable")
                com.inversionlabs.flocksucker.shannon.ShannonDiagStatus.ERROR -> SubsystemStatus.Error(-2, "Error")
            }
            broadcastSubsystemStatus()
        }
    }
    ...
    shannonAnomalyJob = serviceScope.launch {
        shannonDiagMonitor?.anomalies?.collect { anomalies ->
            ...
            for (anomaly in anomalies) {
                ...
                if (anomaly.type == com.inversionlabs.flocksucker.shannon.ShannonAnomalyType.SILENT_SMS) {
                    com.inversionlabs.flocksucker.telephony.HybridSilentSmsRegistry.recordExact(
                ...
                detection?.let { det ->
                    try {
                        ...
                        if (det.threatLevel == com.inversionlabs.flocksucker.data.model.ThreatLevel.CRITICAL ||
                            det.threatLevel == com.inversionlabs.flocksucker.data.model.ThreatLevel.HIGH) {
                            alertUser(det)
                        }
