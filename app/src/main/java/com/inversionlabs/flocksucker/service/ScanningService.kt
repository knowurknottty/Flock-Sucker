...
import com.inversionlabs.flocksucker.adversarial.BleCoTravelerAnalyzer
import com.inversionlabs.flocksucker.adversarial.BleFingerprintInput
import com.inversionlabs.flocksucker.adversarial.BleTailObservation
import com.inversionlabs.flocksucker.adversarial.BleTailRegistry
import com.inversionlabs.flocksucker.telephony.HybridSilentSmsDetector
...
import com.inversionlabs.flocksucker.evidence.AndroidObservationAdapter
import com.inversionlabs.flocksucker.evidence.BleEvidenceKind
import com.inversionlabs.flocksucker.evidence.BleForensicSummary
import com.inversionlabs.flocksucker.evidence.BleTrackerEvidenceClassifier
import com.inversionlabs.flocksucker.evidence.ObservationRecordResult
import com.inversionlabs.flocksucker.evidence.ObservationRecorder
import com.inversionlabs.flocksucker.evidence.RemoteIdEvidence
import com.inversionlabs.flocksucker.evidence.RemoteIdEvidenceDetector
import com.inversionlabs.flocksucker.evidence.rethrowCancellation
import com.inversionlabs.flocksucker.detection.DetectionRegistry
import com.inversionlabs.flocksucker.detection.handler.BleDetectionHandler
...
private const val WAKE_LOCK_TAG = "FlockSucker:ScanningWakeLock"
...
class ScanningService : Service() {
    ...
    @Inject
    lateinit var ephemeralRepository: com.inversionlabs.flocksucker.data.repository.EphemeralDetectionRepository

    @Inject
    lateinit var broadcastSettingsRepository: com.inversionlabs.flocksucker.data.BroadcastSettingsRepository

    @Inject
    lateinit var privacySettingsRepository: com.inversionlabs.flocksucker.data.PrivacySettingsRepository

    @Inject
    lateinit var aiSettingsRepository: com.inversionlabs.flocksucker.data.AiSettingsRepository

    @Inject
    lateinit var scanSettingsRepository: com.inversionlabs.flocksucker.data.ScanSettingsRepository

    @Inject
    lateinit var notificationSettingsRepository: com.inversionlabs.flocksucker.data.NotificationSettingsRepository

    @Inject
    lateinit var detectionSettingsRepository: com.inversionlabs.flocksucker.data.DetectionSettingsRepository

    @Inject
    lateinit var threadingMonitor: com.inversionlabs.flocksucker.monitoring.ScannerThreadingMonitor
    ...
    @Inject
    lateinit var wifiDetectionHandler: com.inversionlabs.flocksucker.detection.handler.WifiDetectionHandler

    @Inject
    lateinit var learnedSignatureHandler: com.inversionlabs.flocksucker.detection.handler.LearnedSignatureHandler

    @Inject
    lateinit var falsePositiveAnalyzer: com.inversionlabs.flocksucker.ai.FalsePositiveAnalyzer

    @Inject
    lateinit var enrichedDataCache: com.inversionlabs.flocksucker.ai.EnrichedDataCache

    @Inject
    lateinit var llmEngineManager: Lazy<com.inversionlabs.flocksucker.ai.LlmEngineManager>

    @Inject
    lateinit var deduplicator: com.inversionlabs.flocksucker.detection.DetectionDeduplicator

    @Inject
    lateinit var crossDomainAnalyzer: com.inversionlabs.flocksucker.ai.correlation.CrossDomainAnalyzer

    // ==================== Settings State ====================

    internal var currentBroadcastSettings: com.inversionlabs.flocksucker.data.BroadcastSettings = com.inversionlabs.flocksucker.data.BroadcastSettings()

    internal var currentPrivacySettings: com.inversionlabs.flocksucker.data.PrivacySettings = com.inversionlabs.flocksucker.data.PrivacySettings()

    internal var currentNotificationSettings: com.inversionlabs.flocksucker.data.NotificationSettings = com.inversionlabs.flocksucker.data.NotificationSettings()

    internal var currentDetectionSettings: com.inversionlabs.flocksucker.data.DetectionSettings = com.inversionlabs.flocksucker.data.DetectionSettings()

    // Current scan settings for battery-adaptive mode calculations
    internal var currentScanSettings: com.inversionlabs.flocksucker.data.ScanSettings = com.inversionlabs.flocksucker.data.ScanSettings()
    ...
    // Satellite monitor
    internal var satelliteMonitor: com.inversionlabs.flocksucker.monitoring.SatelliteMonitor? = null
    ...
    internal var gnssSatelliteMonitor: com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor? = null

    // Shannon SDM diagnostic monitor (OEM only)
    internal var shannonDiagMonitor: com.inversionlabs.flocksucker.shannon.ShannonDiagMonitor? = null
    ...
    override fun onCreate() {
        ...
        satelliteMonitor = com.inversionlabs.flocksucker.monitoring.SatelliteMonitor(applicationContext, detectorCallbackImpl)
    ...
    private fun applyScanSettings(settings: com.inversionlabs.flocksucker.data.ScanSettings) {
    ...
    private fun applyDetectionSettings(settings: com.inversionlabs.flocksucker.data.DetectionSettings) {
    ...
    private fun startScanningAdmitted() {
        ...
        scanJob = serviceScope.launch {
            ...
            while (isActive) {
                ...
                } else if (batteryMode != com.inversionlabs.flocksucker.data.BatteryAdaptiveMode.BALANCED) {
    ...
    private suspend fun checkLearnedSignaturesViaHandler(
        ...
        val context = com.inversionlabs.flocksucker.detection.handler.LearnedSignatureContext.Ble(
            macAddress = macAddress,
    ...
    private fun closeDatabaseConnection() {
        try {
            com.inversionlabs.flocksucker.data.repository.FlockSuckerDatabase.getDatabase(applicationContext).close()
