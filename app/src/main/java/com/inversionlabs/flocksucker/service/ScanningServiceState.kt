...
object ScanningServiceState {
    ...
    const val ACTION_NUKE_INITIATED = "com.inversionlabs.flocksucker.NUKE_INITIATED"
    const val ACTION_DATABASE_SHUTDOWN = "com.inversionlabs.flocksucker.DATABASE_SHUTDOWN"
    ...
    val satelliteState = MutableStateFlow<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionState?>(null)
    val satelliteAnomalies = MutableStateFlow<List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteAnomaly>>(emptyList())
    val satelliteHistory = MutableStateFlow<List<com.inversionlabs.flocksucker.monitoring.SatelliteMonitor.SatelliteConnectionEvent>>(emptyList())
    ...
    val shannonAnomalies = MutableStateFlow<List<com.inversionlabs.flocksucker.shannon.ShannonAnomaly>>(emptyList())

    // GNSS satellite monitoring data
    val gnssStatus = MutableStateFlow<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEnvironmentStatus?>(null)
    val gnssSatellites = MutableStateFlow<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.SatelliteInfo>>(emptyList())
    val gnssAnomalies = MutableStateFlow<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssAnomaly>>(emptyList())
    val gnssEvents = MutableStateFlow<List<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssEvent>>(emptyList())
    val gnssMeasurements = MutableStateFlow<com.inversionlabs.flocksucker.monitoring.GnssSatelliteMonitor.GnssMeasurementData?>(null)
    ...
    val currentBatteryMode = MutableStateFlow(com.inversionlabs.flocksucker.data.BatteryAdaptiveMode.BALANCED)
