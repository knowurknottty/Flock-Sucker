...
class GnssSatelliteMonitor(
    ...
    fun startMonitoring() {
        ...
        try {
            ...
            errorCallback?.onDetectorStarted(com.inversionlabs.flocksucker.service.DetectorHealthStatus.DETECTOR_GNSS)
        } catch (e: Exception) {
            Log.e(TAG, "Error starting GNSS monitoring", e)
            errorCallback?.onError(
                com.inversionlabs.flocksucker.service.DetectorHealthStatus.DETECTOR_GNSS,
    ...
    fun stopMonitoring() {
        ...
        errorCallback?.onDetectorStopped(com.inversionlabs.flocksucker.service.DetectorHealthStatus.DETECTOR_GNSS)
    }
    ...
    private fun processGnssStatus(status: GnssStatus) {
        ...
        errorCallback?.onScanSuccess(com.inversionlabs.flocksucker.service.DetectorHealthStatus.DETECTOR_GNSS)
    }
