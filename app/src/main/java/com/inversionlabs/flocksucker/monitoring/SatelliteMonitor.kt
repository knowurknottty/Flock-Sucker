package com.inversionlabs.flocksucker.monitoring
...
import com.inversionlabs.flocksucker.data.model.SignalStrength as DetectionSignalStrength
...
class SatelliteMonitor(
    ...
    private val errorCallback: com.inversionlabs.flocksucker.service.DetectorCallback? = null
) {
    ...
    fun startMonitoring() {
        ...
        try {
            ...
            errorCallback?.onDetectorStarted(com.inversionlabs.flocksucker.service.DetectorHealthStatus.DETECTOR_SATELLITE)
        } catch (e: Exception) {
            Log.e(TAG, "Error starting satellite monitoring", e)
            errorCallback?.onError(
                com.inversionlabs.flocksucker.service.DetectorHealthStatus.DETECTOR_SATELLITE,
    ...
    fun stopMonitoring() {
        ...
        errorCallback?.onDetectorStopped(com.inversionlabs.flocksucker.service.DetectorHealthStatus.DETECTOR_SATELLITE)
    }
    ...
    private fun checkCurrentState() {
        ...
        errorCallback?.onScanSuccess(com.inversionlabs.flocksucker.service.DetectorHealthStatus.DETECTOR_SATELLITE)
    }
