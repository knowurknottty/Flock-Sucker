...
class OemBrandingE2ETest {
    ...
    fun branding_packageNameIsConsistent() {
        ...
        assertTrue(
            "Package name should be com.inversionlabs.flocksucker or com.inversionlabs.flocksucker.debug",
            packageName == "com.inversionlabs.flocksucker" || packageName == "com.inversionlabs.flocksucker.debug"
        )
    }
