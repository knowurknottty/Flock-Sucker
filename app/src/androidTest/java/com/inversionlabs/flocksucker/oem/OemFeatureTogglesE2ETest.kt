...
class OemFeatureTogglesE2ETest {
    ...
    fun featureToggle_wifiThrottlingBypassRequiresPrivilege() {
        ...
        when (mode) {
            is com.inversionlabs.flocksucker.privilege.PrivilegeMode.Sideload -> {
                assertFalse(
                    "Sideload: Cannot disable WiFi throttling",
                    mode.canDisableWifiThrottling
                )
            }
            is com.inversionlabs.flocksucker.privilege.PrivilegeMode.System -> {
            ...
            is com.inversionlabs.flocksucker.privilege.PrivilegeMode.OEM -> {
                assertTrue(
