...
class OemConfigurationE2ETest {
    ...
    fun config_notificationChannelsAreConfigurable() {
        ...
        val channelName = context.getString(com.inversionlabs.flocksucker.R.string.notification_channel_name)
        val channelDesc = context.getString(com.inversionlabs.flocksucker.R.string.notification_channel_description)
