package com.inversionlabs.flocksucker.oem
...
class OemReadinessE2ETest {
    ...
    fun branding_noHardcodedBrandReferences() {
        ...
        // For sideload/system builds, it should be com.inversionlabs.flocksucker (possibly with .debug suffix).
        ...
        if (BuildConfig.IS_OEM_BUILD) {
            ...
            // For sideload/system builds, package name should be com.inversionlabs.flocksucker
            assertEquals(
    ...
    fun configuration_retentionPeriodsAreFlexible() {
        ...
        val periods = com.inversionlabs.flocksucker.data.RetentionPeriod.entries
    ...
    fun deployment_hasProperPermissionDeclarations() {
        ...
        if (!BuildConfig.IS_OEM_BUILD) {
            assertTrue(
                "Non-OEM package name must start with com.inversionlabs.flocksucker",
                packageInfo.packageName.startsWith("com.inversionlabs.flocksucker")
            )
        }
    }
