...
```bash
# Run all OEM tests
./gradlew connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.package=com.inversionlabs.flocksucker.oem
```
...
```bash
# Branding tests
./gradlew connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=com.inversionlabs.flocksucker.oem.OemBrandingE2ETest

# Configuration tests
./gradlew connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=com.inversionlabs.flocksucker.oem.OemConfigurationE2ETest

# Build variant tests
./gradlew connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=com.inversionlabs.flocksucker.oem.OemBuildVariantsE2ETest

# Resource isolation tests
./gradlew connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=com.inversionlabs.flocksucker.oem.OemResourceIsolationE2ETest

# Feature toggle tests
./gradlew connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=com.inversionlabs.flocksucker.oem.OemFeatureTogglesE2ETest
...
```bash
# Test sideload build
./gradlew connectedSideloadDebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.package=com.inversionlabs.flocksucker.oem

# Test system build
./gradlew connectedSystemDebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.package=com.inversionlabs.flocksucker.oem

# Test OEM build
./gradlew connectedOemDebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.package=com.inversionlabs.flocksucker.oem
```
    ...
    steps:
      ...
      - name: Run OEM tests for ${{ matrix.flavor }}
        ...
        with:
          ...
          target: default
          arch: x86_64
          script: ./gradlew connected${{ matrix.flavor }}DebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.package=com.inversionlabs.flocksucker.oem
...
adb shell pm grant com.inversionlabs.flocksucker android.permission.POST_NOTIFICATIONS
```
