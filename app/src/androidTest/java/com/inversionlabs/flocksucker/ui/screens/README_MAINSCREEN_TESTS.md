...
# For OEM flavor
./gradlew connectedOemDebugAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest"

# For system flavor
./gradlew connectedSystemDebugAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest"
```
...
### Run Single Test
```bash
./gradlew connectedSideloadDebugAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest.mainScreen_canNavigateToHistoryTab"
```
      ...
      - name: Run tests
        run: |
          ./gradlew connectedSideloadDebugAndroidTest \
            --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest"
