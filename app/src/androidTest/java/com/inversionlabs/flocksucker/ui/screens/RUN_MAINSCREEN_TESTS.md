...
./gradlew pixel2api30DebugAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest"
```
...
```bash
./gradlew connectedAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest.mainScreen_*navigation*"
```

### Pull-to-Refresh Tests Only
```bash
./gradlew connectedAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest.mainScreen_*refresh*"
```

### Detection Display Tests Only
```bash
./gradlew connectedAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest.mainScreen_displays*"
```

### Filtering Tests Only
```bash
./gradlew connectedAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest.mainScreen_*filter*"
```
...
./gradlew connectedAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest.mainScreen_canNavigateToHistoryTab"

# Example: Run filtering test
./gradlew connectedAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest.mainScreen_filterByThreatLevelWorks"
```
...
```bash
adb shell pm clear com.inversionlabs.flocksucker
```

### Tests Fail with Permission Errors
**Solution:** Grant permissions manually
```bash
adb shell pm grant com.inversionlabs.flocksucker android.permission.ACCESS_FINE_LOCATION
adb shell pm grant com.inversionlabs.flocksucker android.permission.BLUETOOTH_SCAN
adb shell pm grant com.inversionlabs.flocksucker android.permission.BLUETOOTH_CONNECT
```
...
- name: Run MainScreen E2E Tests
  run: ./gradlew connectedAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest"
```
...
./gradlew connectedAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest.mainScreen_bottomNavigationIsVisible"

# Run critical path (integration tests)
./gradlew connectedAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest.mainScreen_fullUserJourney*"

# Generate HTML report
./gradlew connectedAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest" && open app/build/reports/androidTests/connected/index.html
```
...
| Command | Use Case |
|---------|----------|
| `./gradlew connectedAndroidTest --tests "com.inversionlabs.flocksucker.ui.screens.MainScreenTest"` | Run all tests |
